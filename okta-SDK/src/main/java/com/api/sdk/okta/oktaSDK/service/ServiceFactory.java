...
//import com.microsoft.tokenprovider.ITokenStore;
...
//					ITokenStore tokenStore = AccessTokenHolder.getInstance().getTokenStore();
//					if(tokenStore != null) {
//						tokenStore.storeAccessToken(token);
//						tokenStore.storeRefreshToken(tokenResponse.getRefreshToken());
//					}
//				}
//
